...
#define PS_ON_PIN          -1
    ...
    #define KILL_PIN           41  //FMM disable the kill pin (momentary pushbutton on LCD)
  #else
    #define KILL_PIN           -1
  #endif
  ...
  #define TEMP_BED_PIN       14   // ANALOG NUMBERING
    ...
    #define BEEPER 33
      ...
      #define LCD_PINS_D7 29
        ...
        #define BTN_EN1 33 //Rotery Encoder Richtung 
        #define BTN_EN2 31
        #define BTN_ENC 35
...
#endif //MOTHERBOARD == 3 || MOTHERBOARD == 33 || MOTHERBOARD == 34 || MOTHERBOARD == 35 || MOTHERBOARD == 77 || MOTHERBOARD == 67 || MOTHERBOARD == 68
