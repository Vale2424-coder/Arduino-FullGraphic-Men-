...
#ifndef MOTHERBOARD
#define MOTHERBOARD 35  //FMM only works for this motherboard currently
#endif
...
#define DEFAULT_EXTRUDER_RPM 5 //define default extruder RPM
#define EXTRUDER_RPM_MAX 20 
#define EXTRUDER_RPM_MIN 0.5
#define DEFAULT_PULLER_FEEDRATE 10.0 //default puller feedrate when turned on
#define PULLER_FEEDRATE_MIN 2.0 // min feedrate in manual control, 1 mm/sec min feed - limited by max pulse rate of 50,000
#define PULLER_FEEDRATE_MAX 80.0  // max feedrate in manual control 15mm/sec max feed - limited by max pulse rate of 50,000
...
#define P_ENABLE_ON 0 //FMM for P_AXIS
...
#define DISABLE_P false //FMM for P_AXIS
...
#define INVERT_P_DIR false    //FMM for P_AXIS
...
//// MOVEMENT SETTINGS
#define NUM_AXIS 5 // The axis order in all axis related arrays is X, Y, Z, E, P    //FMM added P_AXIS
#define HOMING_FEEDRATE {50*60, 50*60, 4*60, 0, 0}  // set the homing speeds (mm/min)  //FMM added P_AXIS
